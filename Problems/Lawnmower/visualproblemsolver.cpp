...
Lawnmower::Lawnmower(QWidget *parent, Qt::WFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "Lawnmower");
...
void Lawnmower::MultiThreadedCompute(VectorCases & allCases)
{
...
void Lawnmower::SequencialCompute( VectorCases & allCases )
{
	foreach(LawnmowerCase theCase, allCases) {
...
void Lawnmower::dropEvent( QDropEvent* event )
{
...
QString Lawnmower::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases Lawnmower::ParseInput(QTextStream & inputStream)
{
...
QString Lawnmower::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void Lawnmower::CompareBoxesOutput()
{
	bool passes = false;
...
void Lawnmower::EventFinishedComputation()
{
