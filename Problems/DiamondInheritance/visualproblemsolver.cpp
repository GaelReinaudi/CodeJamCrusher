...
DiamondInheritance::DiamondInheritance(QWidget *parent, Qt::WFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "DiamondInheritance");
...
void DiamondInheritance::MultiThreadedCompute(VectorCases & allCases)
{
...
void DiamondInheritance::SequencialCompute( VectorCases & allCases )
{
...
void DiamondInheritance::dropEvent( QDropEvent* event )
{
...
QString DiamondInheritance::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases DiamondInheritance::ParseInput(QTextStream & inputStream)
{
...
QString DiamondInheritance::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
	if(pathInput.isEmpty()) {
		...
		fileOutName += "DiamondInheritance";
...
void DiamondInheritance::LoadSample()
{
...
void DiamondInheritance::LoadFile()
{
...
void DiamondInheritance::CompareBoxesOutput()
{
	bool passes = false;
...
void DiamondInheritance::EventFinishedComputation()
{
