...
void Buleys::MultiThreadedCompute(VectorCases & allCases)
{
...
void Buleys::SequencialCompute( VectorCases & allCases )
{
...
void Buleys::dropEvent( QDropEvent* event )
{
...
QString Buleys::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases Buleys::ParseInput(QTextStream & inputStream)
{
...
QString Buleys::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void Buleys::CompareBoxesOutput()
{
	bool passes = false;
...
void Buleys::EventFinishedComputation()
{
...
void AppendResult( BuleysCase & theCase, const QString & resultCase )
{
