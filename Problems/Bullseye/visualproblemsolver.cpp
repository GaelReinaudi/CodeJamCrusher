...
Bullseye::Bullseye(QWidget *parent, Qt::WFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "Bullseye");
...
void Bullseye::MultiThreadedCompute(VectorCases & allCases)
{
...
void Bullseye::SequencialCompute( VectorCases & allCases )
{
	foreach(BullseyeCase theCase, allCases) {
...
void Bullseye::dropEvent( QDropEvent* event )
{
...
QString Bullseye::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases Bullseye::ParseInput(QTextStream & inputStream)
{
...
QString Bullseye::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void Bullseye::CompareBoxesOutput()
{
	bool passes = false;
...
void Bullseye::EventFinishedComputation()
{
