...
StandingOvation::StandingOvation(QWidget *parent, Qt::WindowFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "StandingOvation");
...
void StandingOvation::MultiThreadedCompute(VectorCases & allCases)
{
...
void StandingOvation::SequencialCompute( VectorCases & allCases )
{
	foreach(StandingOvationCase theCase, allCases) {
...
void StandingOvation::dropEvent( QDropEvent* event )
{
...
QString StandingOvation::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases StandingOvation::ParseInput(QTextStream & inputStream)
{
...
QString StandingOvation::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void StandingOvation::LoadSample()
{
...
void StandingOvation::CompareBoxesOutput()
{
	bool passes = false;
...
void StandingOvation::EventFinishedComputation()
{
