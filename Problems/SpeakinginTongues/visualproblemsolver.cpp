...
SpeakinginTongues::SpeakinginTongues(QWidget *parent, Qt::WFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "SpeakinginTongues");
...
SpeakinginTongues::~SpeakinginTongues()
{
	m_FileIn.close();
	m_FileOut.close();
...
void SpeakinginTongues::MultiThreadedCompute(VectorCases & allCases)
{
...
void SpeakinginTongues::SequencialCompute( VectorCases & allCases )
{
...
void SpeakinginTongues::dropEvent( QDropEvent* event )
{
...
QString SpeakinginTongues::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases SpeakinginTongues::ParseInput(QTextStream & inputStream)
{
...
QString SpeakinginTongues::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void SpeakinginTongues::LoadSample()
{
...
void SpeakinginTongues::LoadFile()
{
...
void SpeakinginTongues::CompareBoxesOutput()
{
	bool passes = false;
...
void SpeakinginTongues::EventFinishedComputation()
{
	m_FileIn.close();
	m_FileOut.close();
	QString content;
