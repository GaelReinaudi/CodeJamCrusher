...
OutofGas::OutofGas(QWidget *parent, Qt::WFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "OutofGas");
...
void OutofGas::MultiThreadedCompute(VectorCases & allCases)
{
...
void OutofGas::SequencialCompute( VectorCases & allCases )
{
	foreach(OutofGasCase theCase, allCases) {
...
void OutofGas::dropEvent( QDropEvent* event )
{
...
QString OutofGas::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases OutofGas::ParseInput(QTextStream & inputStream)
{
...
QString OutofGas::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void OutofGas::CompareBoxesOutput()
{
	bool passes = false;
...
void OutofGas::EventFinishedComputation()
{
