...
DancingWiththeGooglers::DancingWiththeGooglers(QWidget *parent, Qt::WFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "DancingWiththeGooglers");
...
DancingWiththeGooglers::~DancingWiththeGooglers()
{
	m_FileIn.close();
	m_FileOut.close();
...
void DancingWiththeGooglers::MultiThreadedCompute(VectorCases & allCases)
{
...
void DancingWiththeGooglers::SequencialCompute( VectorCases & allCases )
{
...
void DancingWiththeGooglers::dropEvent( QDropEvent* event )
{
...
QString DancingWiththeGooglers::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases DancingWiththeGooglers::ParseInput(QTextStream & inputStream)
{
...
QString DancingWiththeGooglers::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
	if(pathInput.isEmpty()) {
		...
		fileOutName += "DancingWiththeGooglers";
...
void DancingWiththeGooglers::LoadSample()
{
...
void DancingWiththeGooglers::LoadFile()
{
...
void DancingWiththeGooglers::CompareBoxesOutput()
{
	bool passes = false;
...
void DancingWiththeGooglers::EventFinishedComputation()
{
	m_FileIn.close();
	m_FileOut.close();
	QString content;
...
void AppendResult( DancingWiththeGooglersCase & theCase, const QString & resultCase )
{
