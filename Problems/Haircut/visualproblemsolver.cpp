...
Haircut::Haircut(QWidget *parent, Qt::WindowFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "Haircut");
...
void Haircut::MultiThreadedCompute(VectorCases & allCases)
{
...
void Haircut::SequencialCompute( VectorCases & allCases )
{
	foreach(HaircutCase theCase, allCases) {
...
void Haircut::dropEvent( QDropEvent* event )
{
...
QString Haircut::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases Haircut::ParseInput(QTextStream & inputStream)
{
...
QString Haircut::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void Haircut::CompareBoxesOutput()
{
	bool passes = false;
...
void Haircut::EventFinishedComputation()
{
...
void AppendResult( HaircutCase & theCase, const QString & resultCase )
{
