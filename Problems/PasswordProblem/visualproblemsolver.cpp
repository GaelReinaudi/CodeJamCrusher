...
PasswordProblem::PasswordProblem(QWidget *parent, Qt::WFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "PasswordProblem");
...
void PasswordProblem::MultiThreadedCompute(VectorCases & allCases)
{
...
void PasswordProblem::SequencialCompute( VectorCases & allCases )
{
	foreach(PasswordProblemCase theCase, allCases) {
...
void PasswordProblem::dropEvent( QDropEvent* event )
{
...
QString PasswordProblem::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases PasswordProblem::ParseInput(QTextStream & inputStream)
{
...
QString PasswordProblem::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void PasswordProblem::LoadSample()
{
...
void PasswordProblem::CompareBoxesOutput()
{
	bool passes = false;
...
void PasswordProblem::EventFinishedComputation()
{
	m_FileIn.close();
	m_FileOut.close();
	QString content;
...
void AppendResult( PasswordProblemCase & theCase, const QString & resultCase )
{
