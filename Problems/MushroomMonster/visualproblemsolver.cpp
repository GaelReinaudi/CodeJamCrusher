...
MushroomMonster::MushroomMonster(QWidget *parent, Qt::WindowFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "MushroomMonster");
...
MushroomMonster::~MushroomMonster()
{
	m_FileIn.close();
	m_FileOut.close();
...
void MushroomMonster::MultiThreadedCompute(VectorCases & allCases)
{
...
void MushroomMonster::SequencialCompute( VectorCases & allCases )
{
	foreach(MushroomMonsterCase theCase, allCases) {
...
void MushroomMonster::dropEvent( QDropEvent* event )
{
...
QString MushroomMonster::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases MushroomMonster::ParseInput(QTextStream & inputStream)
{
...
QString MushroomMonster::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void MushroomMonster::LoadSample()
{
...
void MushroomMonster::CompareBoxesOutput()
{
	bool passes = false;
...
void MushroomMonster::EventFinishedComputation()
{
