...
typedef QVector<MagicTrickCase> VectorCases;

QString SolveCase(const MagicTrickCase & theCase);
void AppendResult(MagicTrickCase & theCase, const QString & resultCase);

class MagicTrick : public QWidget
{
	Q_OBJECT

public:
	MagicTrick(QWidget *parent = 0, Qt::WindowFlags flags = 0);
