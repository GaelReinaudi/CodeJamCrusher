...
MagicTrick::MagicTrick(QWidget *parent, Qt::WindowFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "MagicTrick");
...
void MagicTrick::MultiThreadedCompute(VectorCases & allCases)
{
...
void MagicTrick::SequencialCompute( VectorCases & allCases )
{
	foreach(MagicTrickCase theCase, allCases) {
...
void MagicTrick::dropEvent( QDropEvent* event )
{
...
QString MagicTrick::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases MagicTrick::ParseInput(QTextStream & inputStream)
{
...
QString MagicTrick::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void MagicTrick::CompareBoxesOutput()
{
	bool passes = false;
...
void MagicTrick::EventFinishedComputation()
{
...
void AppendResult( MagicTrickCase & theCase, const QString & resultCase )
{
