#ifndef MinesweeperMasterCase_H
#define MinesweeperMasterCase_H
...
class MinesweeperMasterCase : public GoogleCase
{
public:
	MinesweeperMasterCase();
	~MinesweeperMasterCase() {}
