...
FairandSquare::FairandSquare(QWidget *parent, Qt::WFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "FairandSquare");
...
void FairandSquare::MultiThreadedCompute(VectorCases & allCases)
{
...
void FairandSquare::SequencialCompute( VectorCases & allCases )
{
	foreach(FairandSquareCase theCase, allCases) {
...
void FairandSquare::dropEvent( QDropEvent* event )
{
...
QString FairandSquare::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases FairandSquare::ParseInput(QTextStream & inputStream)
{
...
QString FairandSquare::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void FairandSquare::CompareBoxesOutput()
{
	bool passes = false;
...
void FairandSquare::EventFinishedComputation()
{
...
void AppendResult( FairandSquareCase & theCase, const QString & resultCase )
{
