...
typedef QVector<FairandSquareCase> VectorCases;

QString SolveCase(const FairandSquareCase & theCase);
void AppendResult(FairandSquareCase & theCase, const QString & resultCase);

class FairandSquare : public QWidget
{
	Q_OBJECT

public:
	FairandSquare(QWidget *parent = 0, Qt::WFlags flags = 0);
