...
SafetyinNumbers::SafetyinNumbers(QWidget *parent, Qt::WFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "SafetyinNumbers");
...
void SafetyinNumbers::MultiThreadedCompute(VectorCases & allCases)
{
...
void SafetyinNumbers::SequencialCompute( VectorCases & allCases )
{
...
void SafetyinNumbers::dropEvent( QDropEvent* event )
{
...
QString SafetyinNumbers::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases SafetyinNumbers::ParseInput(QTextStream & inputStream)
{
...
QString SafetyinNumbers::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void SafetyinNumbers::LoadSample()
{
...
void SafetyinNumbers::CompareBoxesOutput()
{
	bool passes = false;
...
void SafetyinNumbers::EventFinishedComputation()
{
	m_FileIn.close();
	m_FileOut.close();
	QString content;
...
void AppendResult( SafetyinNumbersCase & theCase, const QString & resultCase )
{
