...
typedef QVector<PerfectHarmonyCase> VectorCases;

QString SolveCase(const PerfectHarmonyCase & theCase);
void AppendResult(PerfectHarmonyCase & theCase, const QString & resultCase);

class PerfectHarmony : public QWidget
{
	Q_OBJECT

public:
	PerfectHarmony(QWidget *parent = 0, Qt::WFlags flags = 0);
