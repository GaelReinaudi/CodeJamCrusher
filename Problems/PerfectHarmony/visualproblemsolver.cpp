...
PerfectHarmony::PerfectHarmony(QWidget *parent, Qt::WFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "PerfectHarmony");
...
void PerfectHarmony::MultiThreadedCompute(VectorCases & allCases)
{
...
void PerfectHarmony::SequencialCompute( VectorCases & allCases )
{
	foreach(PerfectHarmonyCase theCase, allCases) {
...
void PerfectHarmony::dropEvent( QDropEvent* event )
{
...
QString PerfectHarmony::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases PerfectHarmony::ParseInput(QTextStream & inputStream)
{
...
QString PerfectHarmony::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void PerfectHarmony::LoadSample()
{
...
void PerfectHarmony::CompareBoxesOutput()
{
	bool passes = false;
...
void PerfectHarmony::EventFinishedComputation()
{
...
void AppendResult( PerfectHarmonyCase & theCase, const QString & resultCase )
{
