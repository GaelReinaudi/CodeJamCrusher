...
InfiniteHouseOfPancakes::InfiniteHouseOfPancakes(QWidget *parent, Qt::WindowFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "InfiniteHouseOfPancakes");
...
InfiniteHouseOfPancakes::~InfiniteHouseOfPancakes()
{
	m_FileIn.close();
	m_FileOut.close();
...
void InfiniteHouseOfPancakes::MultiThreadedCompute(VectorCases & allCases)
{
...
void InfiniteHouseOfPancakes::SequencialCompute( VectorCases & allCases )
{
	foreach(InfiniteHouseOfPancakesCase theCase, allCases) {
...
void InfiniteHouseOfPancakes::dropEvent( QDropEvent* event )
{
...
QString InfiniteHouseOfPancakes::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases InfiniteHouseOfPancakes::ParseInput(QTextStream & inputStream)
{
...
QString InfiniteHouseOfPancakes::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
	if(pathInput.isEmpty()) {
		...
		fileOutName += "InfiniteHouseOfPancakes";
...
void InfiniteHouseOfPancakes::LoadSample()
{
...
void InfiniteHouseOfPancakes::LoadFile()
{
...
void InfiniteHouseOfPancakes::CompareBoxesOutput()
{
	bool passes = false;
...
void InfiniteHouseOfPancakes::EventFinishedComputation()
{
...
void AppendResult( InfiniteHouseOfPancakesCase & theCase, const QString & resultCase )
{
