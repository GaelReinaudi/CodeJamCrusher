...
typedef QVector<InfiniteHouseOfPancakesCase> VectorCases;

QString SolveCase(const InfiniteHouseOfPancakesCase & theCase);
void AppendResult(InfiniteHouseOfPancakesCase & theCase, const QString & resultCase);

class InfiniteHouseOfPancakes : public QWidget
{
	Q_OBJECT

public:
	InfiniteHouseOfPancakes(QWidget *parent = 0, Qt::WindowFlags flags = 0);
...
private:
	Ui::InfiniteHouseOfPancakesClass ui;
};
