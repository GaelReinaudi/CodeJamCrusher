...
TicTacToeTomek::TicTacToeTomek(QWidget *parent, Qt::WFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "TicTacToeTomek");
...
void TicTacToeTomek::MultiThreadedCompute(VectorCases & allCases)
{
...
void TicTacToeTomek::SequencialCompute( VectorCases & allCases )
{
...
void TicTacToeTomek::dropEvent( QDropEvent* event )
{
...
QString TicTacToeTomek::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases TicTacToeTomek::ParseInput(QTextStream & inputStream)
{
...
QString TicTacToeTomek::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void TicTacToeTomek::LoadSample()
{
...
void TicTacToeTomek::CompareBoxesOutput()
{
	bool passes = false;
...
void TicTacToeTomek::EventFinishedComputation()
{
...
void AppendResult( TicTacToeTomekCase & theCase, const QString & resultCase )
{
