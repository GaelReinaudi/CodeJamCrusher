...
TheRepeater::TheRepeater(QWidget *parent, Qt::WindowFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "TheRepeater");
...
void TheRepeater::MultiThreadedCompute(VectorCases & allCases)
{
...
void TheRepeater::SequencialCompute( VectorCases & allCases )
{
	foreach(TheRepeaterCase theCase, allCases) {
...
void TheRepeater::dropEvent( QDropEvent* event )
{
...
QString TheRepeater::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases TheRepeater::ParseInput(QTextStream & inputStream)
{
...
QString TheRepeater::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void TheRepeater::CompareBoxesOutput()
{
	bool passes = false;
...
void TheRepeater::EventFinishedComputation()
{
