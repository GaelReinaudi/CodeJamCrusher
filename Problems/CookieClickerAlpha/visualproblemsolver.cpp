...
CookieClickerAlpha::CookieClickerAlpha(QWidget *parent, Qt::WindowFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "CookieClickerAlpha");
...
CookieClickerAlpha::~CookieClickerAlpha()
{
	m_FileIn.close();
	m_FileOut.close();
...
void CookieClickerAlpha::MultiThreadedCompute(VectorCases & allCases)
{
...
void CookieClickerAlpha::SequencialCompute( VectorCases & allCases )
{
...
void CookieClickerAlpha::dropEvent( QDropEvent* event )
{
...
QString CookieClickerAlpha::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases CookieClickerAlpha::ParseInput(QTextStream & inputStream)
{
...
QString CookieClickerAlpha::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
	if(pathInput.isEmpty()) {
		...
		fileOutName += "CookieClickerAlpha";
...
void CookieClickerAlpha::LoadSample()
{
...
void CookieClickerAlpha::LoadFile()
{
...
void CookieClickerAlpha::CompareBoxesOutput()
{
	bool passes = false;
...
void CookieClickerAlpha::EventFinishedComputation()
{
