...
OminousOmino::OminousOmino(QWidget *parent, Qt::WindowFlags flags)
	...
	, m_ShowFileContents(true)
{
	ui.setupUi(this);
	// reload settings
	QSettings settings("CodeJam", "OminousOmino");
...
void OminousOmino::MultiThreadedCompute(VectorCases & allCases)
{
...
void OminousOmino::SequencialCompute( VectorCases & allCases )
{
	foreach(OminousOminoCase theCase, allCases) {
...
void OminousOmino::dropEvent( QDropEvent* event )
{
...
QString OminousOmino::MakeSampleInput( QString strFromSampleDrop )
{
...
VectorCases OminousOmino::ParseInput(QTextStream & inputStream)
{
...
QString OminousOmino::MakeFileInOut( QString pathInput  /*= ""*/)
{
	QString content;
	m_FileIn.close();
	QString fileOutName;
...
void OminousOmino::CompareBoxesOutput()
{
	bool passes = false;
...
void OminousOmino::EventFinishedComputation()
{
...
void AppendResult( OminousOminoCase & theCase, const QString & resultCase )
{
